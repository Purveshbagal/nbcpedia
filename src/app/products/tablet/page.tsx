...
import { getProductPath, tabletProducts } from "../products-data";
import ProductSearch from "../ProductSearch";

export const metadata: Metadata = buildPageMetadata({
  title: "Tablet Products",
  description:
    "Explore NBC Pedia's full pediatric tablet range — composition, pack size and dosage details for every tablet.",
    ...
    <main className="product-detail-shell py-8 sm:py-10">
      <BreadcrumbJsonLd
        items={[
          ...
          { name: "Tablet Products", path: "/products/tablet" },
        ]}
      />
      <div className="container-premium">
        <nav aria-label="Breadcrumb" className="mb-4 flex items-center gap-1.5 text-xs font-medium text-slate-500">
          ...
          <span className="text-[#33b53a]">Tablet Products</span>
        </nav>
        ...
        <Reveal>
          <div className="mb-6 sm:mb-8">
            ...
            <p className="mt-2 max-w-2xl text-sm leading-6 text-slate-600">
              Explore our tablet range. Each product includes a quick More Info option.
            </p>
            <ProductSearch products={tabletProducts} placeholder="Search tablet products..." />
          </div>
        </Reveal>
